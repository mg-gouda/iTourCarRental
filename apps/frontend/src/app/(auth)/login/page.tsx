...
export default function LoginPage() {
  ...
  const [storedCredentials, setStoredCredentials] = useState<LoginValues | null>(null);
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      {/* Abstract background — layered radial glows */}
      <div
        aria-hidden
      ...
      >
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={cn(
                  ...
                  'bg-white/8 border text-white placeholder-white/25',
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className={cn(
                    'w-full rounded-lg px-3.5 py-2.5 pr-10 text-sm',
                    'bg-white/8 border text-white placeholder-white/25',
                    'focus:outline-none focus:ring-2 focus:ring-blue-500/60 focus:border-transparent',
                    'transition-all duration-150',
        ...
        {/* ── 2FA Step ── */}
        {step === '2fa' && (
          <form onSubmit={handleTotpSubmit(onTotpSubmit)} noValidate className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              />
              {totpErrors.totpCode && (
                <p className="text-xs text-red-400 text-center">{totpErrors.totpCode.message}</p>
              )}
            </div>
